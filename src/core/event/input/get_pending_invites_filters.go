...
// GetPendingInvitesFilters representa os parâmetros de query para listar convites pendentes
// @Description Parâmetros de paginação para listar convites pendentes de eventos
