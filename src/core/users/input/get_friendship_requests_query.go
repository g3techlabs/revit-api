...
// GetFriendshipRequestsQuery representa os parâmetros de query para listar solicitações de amizade
// @Description Parâmetros de paginação para listar solicitações de amizade pendentes
